...
(function( $ ) {
  ...
  $.csv = {
     ...
     * @param {Integer} [headerIndex] An override for the headerIndex value, the line containing the headers. Defaults to 1.
     * @param {Integer} [start] An override for the start value, the line where the parser should start. Defaults to 1.
     *
    ...
    toObjects: function(csv, options, callback) {
      ...
      config.headerIndex = 'headerIndex' in options ? options.headerIndex : 1;
      ...
      var headerOptions = {
        delimiter: config.delimiter,
        separator: config.separator,
        start: config.headerIndex,
        end: config.headerIndex,
        state: {
          rowNum:1,
          colNum:1
        }
